...
//    }
    ...
    override fun onError(exception: Exception) {
        Log.e(TAG, ".onError called, exception: ${exception.message}")
    }
...
//        Toast.makeText(this, "long tap at position $position", Toast.LENGTH_SHORT).show()
    ...
    override fun onResume() {
        ...
        if (queryResult.isNotEmpty()){
            val url = createUri("https://api.flickr.com/services/feeds/photos_public.gne?tags=android,oreo&format=json&nojsoncallback=1", queryResult, "en-us", true)
